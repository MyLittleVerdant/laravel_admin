@if ($paginator->hasPages())
    <nav>
        <ul class="pagination">
            ...
            @else
                <li class="page-item">
                    <a class="page-link" href="{{  $paginator->url(1)}}" rel="prev" aria-label="first">&lsaquo;&lsaquo;</a>
                </li>
                <li class="page-item">
            ...
            @if ($paginator->hasMorePages())
                ...
                <li class="page-item">
                    <a class="page-link" href="{{ $paginator->url($paginator->lastpage()) }}" rel="next" aria-label="last">&rsaquo;&rsaquo;</a>
                </li>
            @else
